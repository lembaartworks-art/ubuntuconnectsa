...
>
    <div className="relative z-10 container mx-auto grid gap-12 px-6 py-24 md:grid-cols-2 md:py-36 md:items-center">      
            <div className="space-y-6">
              ...
              <h1 className="font-display text-5xl font-black leading-tight text-foreground md:text-6xl lg:text-7xl">
                Together, We Can Change a Life Today.
<br />
<span className="text-accent">
Every act of kindness creates hope for someone in need.
</span>
                <span className="text-accent">Together, we can change someone's tomorrow.</span>
              </h1>
              <p className="max-w-xl text-lg text-muted-foreground">
                Ubuntu Connect SA is a community platform connecting donors, volunteers, NGOs, churches, businesses and schools with individuals and families who need support across South Africa. Every donation, every volunteer, and every helping hand brings hope to someone who needs it most.
              </p>
              <div className="flex flex-wrap gap-3">
                <Button
  asChild
  size="lg"
  className="rounded-full px-8 py-6 text-lg font-bold shadow-xl transition-all duration-300 hover:scale-105 hover:bg-destructive/90"
>
  ...
  size="lg"
  variant="outline"
  className="rounded-full px-8 py-6 text-lg font-bold border-2 transition-all duration-300 hover:scale-105"
>
  ...
  asChild
  size="lg"
  className="rounded-full px-8 py-6 text-lg font-bold shadow-xl transition-all duration-300 hover:scale-105 hover:bg-accent/90"
>
