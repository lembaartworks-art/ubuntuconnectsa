...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ubuntu Connect SA — Connecting Hearts. Changing Lives." },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Ubuntu Connect SA" },
      { property: "og:title", content: "Ubuntu Connect SA — Connecting Hearts. Changing Lives." },
      {
